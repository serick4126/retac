...
public static class CommandLabels
{
    ...
    [
        ...
        ("移動", CommandId.GoParent, "親フォルダに戻る"),
        ("移動", CommandId.GoRoot, "ルートフォルダに戻る"),
        ("移動", CommandId.GoBack, "前のフォルダに戻る"),
        ("移動", CommandId.GoForward, "次のフォルダに進む"),
        ("移動", CommandId.FolderHistory, "フォルダ履歴"),
        ("移動", CommandId.QuickAccess, "クイックアクセス"),
        ("移動", CommandId.QuickAccessAdd, "クイックアクセスに追加"),
        ("移動", CommandId.DirectJump, "ダイレクトジャンプ"),
        ("移動", CommandId.SelectDrive, "ドライブの選択"),
        ("移動", CommandId.DriveByNumberKey, "数字キーのドライブ移動"),
        ("移動", CommandId.GoDesktop, "デスクトップへ移動"),
