...
public static class CommandLabels
{
    ...
    [
        ...
        ("表示", CommandId.ShowDriveTree, "ドライブツリーを表示"),
        ("表示", CommandId.ShowDesktopTree, "デスクトップツリーを表示"),
        ("表示", CommandId.ShowBookmarksView, "ブックマークを表示"),
        ("表示", CommandId.ShowPreview, "プレビューを表示"),
        ("表示", CommandId.ToggleLeftPanel, "左パネルの表示切り替え"),
        ("表示", CommandId.ShowPopupMenu, "ポップアップメニューの表示"),
        ("表示", CommandId.ShowContextMenu, "右クリックメニューの表示"),
        ("表示", CommandId.ShowFolderBackgroundMenu, "現在のフォルダの右クリックメニューの表示"),
